		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i>+628-3334-5445</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> HEKALA@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>HEKALA KHAS HANDIL</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar " style="padding: 5px; background-color: #4d0000;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #fff;"><b>HEKALA</b></a>
			</div>
					...
					if(!isset($_SESSION['user'])){
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="user_login.php">Login User</a></li>
